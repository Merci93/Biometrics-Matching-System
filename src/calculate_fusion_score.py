...
def compare_fingerprints(data_1, data_2) -> float:
    ...
    """
    orb = cv2.ORB_create()
    key_points_1, descriptors_1 = orb.detectAndCompute(data_1, None)
    key_points_2, descriptors_2 = orb.detectAndCompute(data_2, None)
    ...
    similarity_score = len(matching_points) / len(key_points_1)
